  ...
  section.innerHTML = `
    ...
    <div class="detail-content__column">
      ...
      <div class="detail-content__cta">
        ${props.repoUrl ? `<a class="btn btn--primary" href="${escapeHtml(props.repoUrl)}" target="_blank" rel="noopener">Voir sur GitHub →</a>` : ""}
        ${props.demoUrl ? `<a class="btn btn--outline" href="${escapeHtml(props.demoUrl)}" target="_blank" rel="noopener">Voir le projet →</a>` : ""}
      </div>
    </div>
  `;
