...
export const aboutMock = {
    ...
    offeringsImage: {
        url: "../../assets/fritzi/home/LEAF.svg",
        alt: "feuille de plante verte"
    }
};
...
export const aboutMeMock = {
    heading: "About me",
    quote: {
        lead: "A [tech-driven] perspective shaped by",
        highlight1: "Front-end",
        connector: "and a",
        highlight2: "Back-end",
        tail: "upbringing."
    },
    caption: "A design approach led by curiosity, logic, and empathy. All digital experiences are crafted to be intuitive, functional, and quietly delightful.",
    portrait: {
        url: "../../assets/fritzi/home/bg-about-me.svg",
...
export const contactMock = {
    heading: ["Come", "say", "hi"],
    logo: {
        url: "../../assets/fritzi/home/logo-cadre-white.svg",
        alt: "Logo tête de chat"
    },
    nav: ["Home", "Work", "About / Services"],
