export const projectDetailMock = {
    ...
    heroImage: {
        url: "https://placehold.co/1200x700/D8D2C4/1a1a1a?text=TV+App+Mockup",
        alt: "Mockup de l'application TV sur un ordinateur portable"
    },

    overview: {
        sideLabel: "Linkedin",
        eyebrow: "Overview",
        heading: "Digital tools often isolate us. This TV application replaces endless scrolling with shared daily moods, campus updates, and lunch decisions.",
        paragraphs: [
    ...
    discovery: {
        ...
        image: {
            ...
            alt: "Carte de visite .decode posée sur une table"
        }
    },
    ...
    challenge: {
        ...
        backgroundImage: {
            url: "https://placehold.co/1600x1000/141414/141414?text=+",
    ...
    outcome: {
        ...
        image: {
            url: "https://placehold.co/700x520/1a1a1a/EDE9DD?text=Installation",
            alt: "Équipe installant l'écran TV sur le mur du campus"
        }
    },
    ...
    nextProject: {
        ...
        client: ".decode",
        tag: "Website / Responsive",
        cover: {
            url: "https://placehold.co/900x620/1a1a1a/EDE9DD?text=L%27ecole",
